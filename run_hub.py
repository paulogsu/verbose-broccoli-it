...
OUTPUT_ICAL_FILE = "hub_schedule.ics"
SCHEDULE_YEAR = 2025
TEAM_MEMBERS = [
    "Tassiana Bastos","FABIO FILIPE PEREIRA","ARNOLD LUANZAMBI",
...
for f in os.listdir(FILES_DIR):
    if "HUB_2025.xlsx" in f:
        excel_file = os.path.join(FILES_DIR, f)
        break

if not excel_file:
    sys.exit(f"ERROR: Cannot find Excel file containing HUB_2025.xlsx in {FILES_DIR}")
...
cal = Calendar()
cal.add('prodid','-//HubServices Team Schedule//mxm.dk//')
cal.add('version','2.0')
all_events = []
